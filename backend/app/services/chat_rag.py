...
Format response professionally using markdown.
...
- NEVER combine heading and text on same line
...
def retrieve_context(
    ...
    summary_query = is_summary_query(
        question
    )
...
async def stream_chat_with_rfp(
